...
class ListaSuperApp(App):
    def build(self):
        ...
        instruction_label = Label(text="App lista del super", font_size='30sp', color = (0, 0, 0, 1))
        layout.add_widget(instruction_label)

        self.producto_input = TextInput(hint_text="Ingrese nombre del producto", font_size='16sp', multiline=False, size_hint_y=None, height=100)
        layout.add_widget(self.producto_input)

        self.costo_input = TextInput(hint_text="Ingrese costo del producto", font_size='16sp', multiline=False, input_filter='float', size_hint_y=None, height=100)
        ...
        self.lista_productos = BoxLayout(orientation='vertical', size_hint_y=None, spacing = 20)
